...
vim.keymap.set('n', '<leader>ot', ':vert term<CR>', { noremap = true, silent = true, desc = 'Open a terminal in vsplit' })
...
-- NeoTree
vim.keymap.set('n', '<leader>e', '<Esc>:Neotree toggle<CR>', { noremap = true, desc = 'Open NeoTree files explorer' })
vim.keymap.set('n', '<leader>eb', '<Esc>:Neotree toggle source=buffers<CR>', { noremap = true, desc = 'Open NeoTree buffers explorer' })
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>su', '<cmd>Telescope undo<cr>', { desc = '[S] Find [U]undo' })
      vim.keymap.set('n', '<leader>sb', builtin.current_buffer_fuzzy_find, { desc = '[S]earch [B]uffer for string' })
